...
export const faqItems = [
  ...
  },
  {
    ...
    answer: "Да, мы выполняем заказы не только в Воронеже, но и по всей Воронежской области. Выезд на замер в пределах 50 км от города — бесплатно. При заказах в более отдаленные районы стоимость выезда рассчитывается индивидуально."
  }
];

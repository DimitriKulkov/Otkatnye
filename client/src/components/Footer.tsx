        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-white/90 mb-6 max-w-md">
              Профессиональная установка заборов, навесов и ворот в Москве и Московской области с 2010 года.
            </p>
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <MapPin className="h-5 w-5 text-[#A1B189]" />
                <span className="text-white/80">Москва и Московская область</span>
              </div>
              <div className="flex items-center gap-3">
          ...
          <div>
            <h4 className="text-lg font-bold mb-4 border-b border-[#A1B189] pb-2 inline-block">Услуги</h4>
            <ul className="space-y-2 mt-3">
              <li><a href="#services" className="text-white/80 hover:text-white hover:pl-1 transition-all">Заборы</a></li>
              <li><a href="#services" className="text-white/80 hover:text-white hover:pl-1 transition-all">Навесы</a></li>
              <li><a href="#services" className="text-white/80 hover:text-white hover:pl-1 transition-all">Ворота и калитки</a></li>
              <li><a href="#services" className="text-white/80 hover:text-white hover:pl-1 transition-all">Автоматика для ворот</a></li>
            </ul>
          </div>
          <div>
            <h4 className="text-lg font-bold mb-4 border-b border-[#A1B189] pb-2 inline-block">Контакты</h4>
            <ul className="space-y-3 mt-3">
              <li>
                <a href="tel:+78953720542" className="text-white/80 hover:text-white flex items-center gap-2">
